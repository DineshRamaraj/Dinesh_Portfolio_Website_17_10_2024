      ...
      <center>
        <div className="w-[400px] h-[400px] rounded-full">
          <img
            ...
            alt="portfolio"
            className="rounded-full border-4 border-slate-300 w-full h-full brightness-50 hover:brightness-100 hover:scale-110 duration-200"
          />
        </div>
      </center>
      <div className="name-details-container text-slate-200 text-center md:text-start order-1 md:order-0">
        <h1 className="name-heading text-[34px] md:text-[48px] text-green-500 font-bold font-[sans]">
          Dineshkumar Ramaraj
        </h1>
        <p className="text-[32px]">
          I am{" "}
          <span className="typing-element text-[32px] md:text-[38px] text-blue-600"></span>
        </p>
      </div>
    </div>
  );
